...
final class FooBarTest extends TestCase {
    ...
    public function testFooBar(int $number, string $answer): void {
	
        $this->assertEquals($answer, $this->testObject->getFooBar($number));
    }
    ...
    public function providerSeveralMultiples(): array {
        ...
        $data = [[15, 'Foo, Bar'], [30, 'Foo, Bar'], [45, 'Foo, Bar'], [21, 'Foo'], [35, 'Bar']];
